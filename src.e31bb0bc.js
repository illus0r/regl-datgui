...
var gui = new dat.GUI();
var params = {}; //params['red'] = {value: 0.0,}
...
for (var key in params) {
  ...
  var p = params[key]; //gui.add(params, 'red', ('min' in p)?p.min:0, ('max' in p)?p.max:1);
...
var obj = {
  'Save image': function SaveImage() {
    ...
    console.log(canvas.toDataURL("image/png")); //let imageURI = canvas.toDataURL("image/jpg");
...
var setupQuad = regl({
  ...
  uniforms: {
    ...
    time_: function time_() {
      return params['time_'];
    },
    spotSeed: function spotSeed() {
      return params['spotSeed'];
    },
    colorShift_: function colorShift_() {
      return params['colorShift_'];
    },
    spotRadius: function spotRadius() {
      return params['spotRadius'];
    },
    spotDetails: function spotDetails() {
      return params['spotDetails'];
    },
    spotAmplitude: function spotAmplitude() {
      return params['spotAmplitude'];
    },
    blur: function blur() {
      return params['blur'];
    },
...
},{"./shader.frag":"shader.frag","regl":"../node_modules/regl/dist/regl.js","dat.gui":"../node_modules/dat.gui/build/dat.gui.module.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
